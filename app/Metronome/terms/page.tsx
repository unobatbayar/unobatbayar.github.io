...
export const metadata = pageSocialMetadata({
  title: "Metronome Glow Terms",
  description: "Terms for the Metronome Glow iPhone app.",
  path: "/Metronome/terms",
...
const TermsAndConditionsPage = () => {
    return (
        <div>
            <h2 className="font-semibold text-2xl mb-4">Terms &amp; Conditions</h2>
            <p className="mb-4">
            ...
            <p className="mb-4">
                The Metronome Glow app stores and processes personal data that you have provided to us, to provide my Service. It's your responsibility to keep your phone and access to the app secure. We therefore recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone's security features and it could mean that the Metronome Glow app won't work properly or at all.
            </p>
            <p className="mb-4">
            ...
            <h3 className="font-semibold text-xl mt-6 mb-4">Changes to This Terms and Conditions</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
                If you have any questions or suggestions about my Terms and Conditions, do not hesitate to <a href="https://x.com/unoryas" target="_blank" rel="noopener noreferrer" className="text-blue-600">contact me</a>.
            </p>

            <p className="mt-8 text-sm text-center">
                This Terms and Conditions page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600">App Privacy Policy Generator</a>
            </p>
        </div>
    );
};
