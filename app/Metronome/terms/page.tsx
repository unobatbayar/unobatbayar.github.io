...
const TermsAndConditionsPage = () => {
    return (
        <div>
            ...
            <p className="mb-4">
                If you have any questions or suggestions about my Terms and Conditions, do not hesitate to <a href="mailto:unobatbayar@protonmail.com" className="text-blue-600">contact me</a>.
            </p>
