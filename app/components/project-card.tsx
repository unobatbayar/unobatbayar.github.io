  ...
  return (
    ...
    >
      <TiltCard className="h-full rounded-2xl">
        <div className="glass-panel relative flex h-full min-h-[260px] overflow-hidden rounded-2xl p-6 transition-all duration-300 group-hover:-translate-y-1 group-hover:border-blue-200 group-hover:shadow-xl group-hover:shadow-blue-500/10 dark:group-hover:border-blue-900">
          ...
          <div className="relative flex flex-col gap-5">
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <h3 className="text-lg font-semibold tracking-tight text-black transition-colors group-hover:text-blue-600 dark:text-white dark:group-hover:text-blue-400">
                      {project.title}
                    </h3>
            ...
            <p className="border-t border-neutral-200/80 pt-4 text-sm font-medium leading-6 text-blue-600 dark:border-neutral-800 dark:text-blue-400">
              {project.tools}
            </p>
          </div>
        </div>
